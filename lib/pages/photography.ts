...
const roll002Photos: LooseRollMedia[] = [
  ...
  mediaPath("roll002", "elgeet.JPEG"),
  mediaPath("roll002", "elgeet1.JPEG"),
  mediaPath("roll002", "elstee.JPEG"),
  mediaPath("roll002", "elstee1.JPEG"),
  mediaPath("roll002", "elstee2.JPEG"),
  ...
  mediaPath("roll002", "fqs 2025-05-22 194947.362.JPG"),
  mediaPath("roll002", "kap.JPEG"),
  mediaPath("roll002", "kap2.JPEG"),
  ...
  mediaPath("roll002", "fqs 2025-06-04 162521.960.JPEG"),
  mediaPath("roll002", "fqs 2025-06-05 054113.872.JPEG"),
  mediaPath("roll002", "her.JPEG"),
  mediaPath("roll002", "her1.JPEG"),
  mediaPath("roll002", "her2.JPEG"),
  ...
  mediaPath("roll002", "pool.JPEG"),
  mediaPath("roll002", "pool1.JPEG"),
  mediaPath("roll002", "fqs 2025-06-15 141710.517.JPEG"),
  mediaPath("roll002", "taro.JPEG"),
  mediaPath("roll002", "taro1.JPEG"),
  mediaPath("roll002", "taro2.JPEG"),
  ...
  mediaPath("roll002", "unc1.JPEG"),
  mediaPath("roll002", "fqs 2025-07-11 054519.317.JPEG"),
